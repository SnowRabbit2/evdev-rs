...
pub const LIBEVDEV_UINPUT_OPEN_MANAGED: libc::c_int = -2;
...
extern {
    ...
    pub fn libevdev_uinput_create_from_device(dev: *const libevdev,
                                              uinput_fd: c_int,
                                              uinput_dev: *mut *mut libevdev_uinput) -> c_int;
    ...
    pub fn libevdev_uinput_get_syspath(uinput_dev: *const libevdev_uinput) -> *const c_char;
    pub fn libevdev_uinput_get_devnode(uinput_dev: *const libevdev_uinput) -> *const c_char;
    pub fn libevdev_uinput_write_event(uinput_dev: *mut libevdev_uinput,
                                       type_: c_uint,
                                       code: c_uint,
                                       value: c_int) -> c_int;
}
